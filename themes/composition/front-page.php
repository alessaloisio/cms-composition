...
<section class="section_introduction">
  ...
  <div class="introduction_col-d">
    ...
    <div class="introduction_img" style="background: url(<?php echo get_field('introduction_image')['sizes']['medium_large']; ?>) no-repeat center center;"></div>
    </div>
  </div>
</section>
...
<section class="section_inferieur">
  ...
  <div class="inferieur_col-d">
    <div class="inferieur_container-white">
